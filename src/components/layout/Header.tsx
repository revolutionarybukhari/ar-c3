    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#0f1a2e] bg-[#060a12]/98 backdrop-blur-sm">
      <div className="flex h-10 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="hidden lg:inline text-[9px] font-medium tracking-[0.2em] text-slate-600 uppercase border-l border-slate-800 pl-2.5 ml-0.5">
        ...
        <nav className="flex items-center gap-0.5">
          {navItems.map((item) => (
            <button
              ...
              className={cn(
                "px-3 py-1 text-[10px] font-semibold tracking-[0.15em] transition-colors",
                activeView === item.id
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-semibold tracking-wider text-emerald-400 uppercase">Live</span>
          </div>
          ...
          <div className="flex items-center rounded border border-[#1a2236]">
            {regions.map((r) => (
              <button
                ...
                className={cn(
                  "px-2 py-0.5 text-[10px] font-semibold tracking-wider transition-colors",
                  activeRegion === r.id
